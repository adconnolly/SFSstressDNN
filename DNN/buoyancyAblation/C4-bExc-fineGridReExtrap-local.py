...
sizeStr=str(size)
scaleStr='local'
saveFile='C4_bOut2_fineGridReExtrap_'+scaleStr+'_' 
files=["coarse4x513_Re900.nc","coarse4x1026_Re1800.nc"]
fileUgs=[0.025,0.05]
fileRes=[900.,1800.]
fileB0s=[0.0005, 0.0044]
filemaskpercents=[0.001462766  ,0.01462766 ]
valMaskPercent = 0.5

testFiles=["coarse4x1539_Re2700.nc"]
testfileUgs=[0.075]
testfileRes=[2700.]
testfileB0s=[0.0349]
...
for irun in range(Nruns):
    ...
    print("Train Files:")
    x_train, y_train, tauScale_train, trainMask = preprocess_noB(files, filemaskpercents, scaleStr, fileUgs, fileRes, fileB0s, size, irun)
