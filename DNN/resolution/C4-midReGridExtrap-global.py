...
files=["coarse4x1026_Re1800.nc","coarse4x2052_Re1800.nc"]
fileUgs=[0.05,0.05]
fileRes=[20000.,20000.]
fileB0s=[-0.0044, -0.0044]
filemaskpercents=[0.12,1]
valMaskPercent = 0.5

testFiles=["coarse4x40104_Re1800.nc"]
testfileUgs=[0.05]
testfileRes=[20000.]
testfileB0s=[-0.0044]
testfilemaskpercents=[0.8]
