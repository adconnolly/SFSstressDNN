...
for irun in range(Nruns):
    ...
    xtest, ytest, tauScaletest, testMask = preprocess_dataAug(testFiles, testfilemaskpercents, scaleStr, testfileUgs, testfileRes, testfileB0s, size, irun, krotAll=[3],maskdict=auxDataDict)
